...
<a href="MANAGEMENT/admintutor.php"><img id="back" src="ICON/back.png" alt=""></a>
...
<button  type="submit" onclick="alert('Do you really want to Delete');" id="btn" name="delete">Delete</button>
