...
<head>
    ...
    <link rel="stylesheet" href="PAKAGES/userpackages.css">
...
<div class="dropdown">
  ...
  <a id="bt" href="logout.php">Log out</a>
    ...
    <?php endif; ?> 
      ...
      <div class="conpakages">
        <div class="con">
         <div class="con_content">
             <h1>Explore EdSpecial’s <span style="color: rgb(52, 134, 189);"> Package Deals</span></h1>
             <p>EdSpecial caters to students from preschool to Grade 6 and offers a wide range of <br> subjects:</p>
         </div>

         <div class="con_grid_sub">
            <div class="con_sub">
            ...
            <div class="con_sub">
                ...
                <div class="sub">
                    <img src="subject/aralin.png" alt="">
         ...
         <div class="contain">
            <div class="conpack">
                ...
                <div class="conpac">
                    ...
                    1 subject</p>
                    <div class="conbtn">
                    <a href="bookingprocess.php">BOOK TRIAL</a>
                    </div>
                </div>
            </div>
        </div>
