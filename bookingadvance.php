...
<body>
     <div class="container">
        <div class="forms">
            <div class="formlogin">
                <span class="title">ADVANCE LEARNER</span>
            
                <h5 style="color:gray;">Our ADVANCE LEARNER Session class consist of 1-hour every session</h5>
           <br><h2>Child Info</h2>
          ...
          <?php endif; ?>
            ...
            <select name="packagename" >
                        <option value="ADVANCE LEARNER" >ADVANCE LEARNER</option>
                    </select>
            ...
            <label for="date" >Set Date</label>
                 ...
                 <br>   <div class="input-grade" required>
                    ...
                    <select name="session" >
                     ...
                     <div class="input-fileds">
                     <input value="1799" placeholder=" Package Price" name="price"/>
