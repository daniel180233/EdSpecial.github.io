...
<body>
     <div class="container">
        <div class="forms">
            <div class="formlogin">
                <span class="title">Free Trial</span>
            
                <h5 style="color:gray;">Our Trial Session class consist of 1-hour session</h5>
           <br><h2>Child Info</h2>
            ...
            <label for="date" >Set Date</label>
                 ...
                 <br>   <div class="input-grade" required>
                    ...
                    <select name="session" >
                     ...
                     <div class="input-fileds">
                     <input value="0" placeholder=" Package Price" name="price"/>
