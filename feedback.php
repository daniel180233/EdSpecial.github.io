...
if(isset($_POST['submit'])){
  ...
  $sql = "INSERT INTO `feed`(f_name,f_email,f_message)
  VALUES ('$name','$email','$message')";
  $con->query($sql) or die ($con->error);

  echo header("Location: feedback.php");
...
<body>
    ...
    <section class="home">
      ...
      <div>
        ...
        <h1>Welcome to EdSpecial Feedback </h1>
        ...
        <div class="kocontent">
            ...
            <div class="container">
             ...
             <div class="con_grid">
            	    ...
            	    <input  onclick="alert('Successfully Send');" type="submit" name="submit" id="btn" value="Send Message">
