...
<body>
     <div class="container">
        <div class="forms">
            <div class="formlogin">
                <span class="title">WHIZ KID</span>
            
                <h5 style="color:gray;">Our WHIZ KID Session class consist of 1-hour every session</h5>
           <br><h2>Child Info</h2>
          ...
          <?php endif; ?>
            ...
            <select name="packagename" >
                        <option value="WHIZ KID" >WHIZ KID</option>
                    </select>
            ...
            <label for="date" >Set Date</label>
                  ...
                  <br>  <div class="input-grade" required>
                    ...
                    <select name="time" >
                        ...
                        <option value="8:00 - 11:00 am">8:00 am- 11:00 am</option>
                        <option value="1:00 - 2:00 pm">1:00 pm- 5:00 pm</option>
                    ...
                    <select name="subject" id="Grade" >
                        ...
                        <option value="English Math Filipino Science">English,Math,Filipino,Science</option>
                        <option value="English Math Reading Science">English,Math,Reading,Science</option>
                        <option value="Reading English Filipino Reading">English,Science,Reading,Science</option>
                        <option value="Araling Panlipunan Science Reading Science">Araling Panlipunan,Science,Reading,Science</option>
                        <option value="Math Araling Panlipunan Reading Science">Math,Araling Panlipunan,Reading,Science</option>
                    </select>
                     </div>
                    ...
                    <select name="session" >
                     ...
                     <div class="input-fileds">
                     <input value="999" placeholder=" Package Price" name="price"/>
